...
extension Story {
    var artwork: UIImage {
        switch self {
        case .returnTrip: return #imageLiteral(resourceName: "ReturnTrip.png")
        case .touchDown: return #imageLiteral(resourceName: "TouchDown.png")
        case .homeward: return #imageLiteral(resourceName: "Homeward.png")
        case .rover: return #imageLiteral(resourceName: "Rover.png")
        case .cave: return #imageLiteral(resourceName: "Cave.png")
        case .crate: return #imageLiteral(resourceName: "Crate.png")
        case .monster: return #imageLiteral(resourceName: "Monster.png")
        case .droid: return #imageLiteral(resourceName: "Droid.png")
        case .home: return #imageLiteral(resourceName: "Home.png")
        }
    }
